    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card shadow mb-4">
            ...
            <div
                ...
                <h6 class="m-0 font-weight-bold text-primary">Tambah Jam</h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">
            <?php
                    ...
                    ?>
                    <form action="<?php echo base_url()?>jam/store" method='POST'>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="batas_awal">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Batas Akhir Jam</label>
                        <input type="datetime-local" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="batas_akhir">
                    </div>
                    <div class="mb-3">
